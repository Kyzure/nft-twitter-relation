...
app.get('/all-collections-info', (req, res) => {
    ...
    SELECT DISTINCT opensea_top100.name, opensea_top100.average_price, opensea_top100.floor_price, opensea_top100.total_volume, opensea_top100.total_sales, opensea_top100.total_supply, opensea_top100.count, opensea_top100.num_owners, opensea_top100.market_cap, Z.retweet_count, Z.reply_count,tw_user.followers_count, tw_user.tweet_count
