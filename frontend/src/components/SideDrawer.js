...
function SideDrawer(props) {
  ...
  function GetData(name, marketplace) {
    ...
    */
    axios
      .get("http://139.99.72.60:4000/all-collections-info")
      .then((response) => {
            ...
            >
              ...
              >
                ...
                <Autocomplete
                  ...
                  defaultValue={
                    collectionOptions.length === 0 ? [] : [collectionOptions[0]]
                  }
                  renderInput={(params) => (
                    <TextFieldStyled
                      {...params}
                  ...
                  PaperComponent={({ children }) => (
                    <Paper style={{ color: "#202020" }}>{children}</Paper>
                  )}
                />
              </Stack>
            </Stack>
